...
function BigCam() {
  ...
  const moveWebcam = () => {
    bgremoveLayer.dx =
      (rndRef.current.draggable.state.x - canvasRef.current.offsetLeft) / W;
    bgremoveLayer.dy =
      (rndRef.current.draggable.state.y - canvasRef.current.offsetTop) / H;
  };
