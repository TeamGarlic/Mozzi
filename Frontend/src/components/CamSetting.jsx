        ...
        <div className="flex-col w-80 h-fit rounded-xl bg-white my-3">
          ...
          >
            <div className="columns-2">
              <label className="block text-sm font-medium text-gray-900 dark:text-white">카메라 회전 : {`${degreeValue}°`}</label>
              <div className="flex">
              ...
              <label htmlFor="degreeCheckbox"
                     className="block text-sm font-medium text-gray-900 dark:text-white">저는 관종입니다</label>
              </div>
            </div>
            ...
            <hr  className="my-2"/>
            <div className="columns-2">
              <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">카메라 크기 : {`${scaleValue}%`}</label>
              <div className="flex">
