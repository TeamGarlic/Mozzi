...
public class MozziUtilImpl implements MozziUtil {
    ...
    private static final String[][] seeds = {
        ...
        },
        {
            ...
            "귀여운", "매력적인", "편리한", "친절한", "순수한", "청결한", "상냥한", "예의바른", "높은", "먼", "정직한", "성실한", "공정한", "버릇없는", "더러운",
        ...
        },
        {
            ...
            "사슴벌레", "장수풍댕이", "하늘소", "달팽이", "카멜레온", "개미", "나비", "꽃등에", "다람쥐", "구관조", "고슴도치", "오리", "개", "토끼", "뱀", "새",
            "코끼리", "너구리", "고양이", "다람쥐", "노루", "사슴", "청설모", "말", "얼룩말", "낙타", "개구리", "물고기", "호랑이", "사자", "표범", "치타",
            "타조", "거북이", "자라", "문어", "오징어", "병아리", "닭", "소", "개미", "바퀴벌레", "거머리", "소금쟁이", "영양", "개미핥기", "맘모스", "바다사자",
            "고래", "돌고래", "바다표범", "나방", "박쥐", "반딧불이", "올빼미", "부엉이", "말", "나비", "칼리브", "사향소", "브롱혼", "순록", "양", "기린", "하마"
        }
    };
