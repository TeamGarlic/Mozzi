...
public class MozziUtilImpl implements MozziUtil {
    ...
    private static final String[][] seeds = {
        ...
        },
        {
            ...
            "타조", "거북이", "자라", "문어", "오징어", "병아리", "닭", "소", "개미", "소금쟁이", "영양", "맘모스", "바다사자", "새우", "펭귄",
